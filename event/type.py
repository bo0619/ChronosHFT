...
class ExchangeOrderUpdate:
    ...
    market_trade_price: Optional[float] = None
    market_trade_qty: Optional[float] = None
    market_trade_exchange_time: Optional[float] = None
    market_trade_received_time: Optional[float] = None
    market_trade_clock_offset_ms: Optional[float] = None
    market_trade_transport_latency_ms: Optional[float] = None
    market_trade_local_age_ms: Optional[float] = None
